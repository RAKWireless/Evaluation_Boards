...
#define LORAWAN_DUTYCYCLE_ON false /**< LoRaWAN ETSI duty cycle control enable/disable. Please note that ETSI mandates duty cycled transmissions. Use only for test purposes */
