...
// the bytes. 
static const u1_t PROGMEM APPEUI[8]={0x1A,0xFE,0x01,0xD0,0x7E,0xD5,0xB3,0x70};
...
static const u1_t PROGMEM APPKEY[16] = { 0x45,0xBA,0x29,0x8E,0x71,0xFA,0xA5,0x33,0xFA,0xBC,0xD6,0x89,0xBE,0xB6,0xC7,0x27 };
