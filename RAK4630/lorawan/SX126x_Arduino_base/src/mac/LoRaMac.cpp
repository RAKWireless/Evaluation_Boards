 ...
 */
	...
	static void OnMacStateCheckTimerEvent(void)
	{
        ...
        // Serial.println("=====S1=====OnMacStateCheckTimerEvent=================");
		TimerStop(&MacStateCheckTimer);

		if (LoRaMacFlags.Bits.MacDone == 1)
		{
		// Serial.println("=====m1=====OnMacStateCheckTimerEvent=================");
			...
			if ((LoRaMacFlags.Bits.MlmeReq == 1) || ((LoRaMacFlags.Bits.McpsReq == 1)))
			{
				if ((McpsConfirm.Status == LORAMAC_EVENT_INFO_STATUS_TX_TIMEOUT) ||
					(MlmeConfirm.Status == LORAMAC_EVENT_INFO_STATUS_TX_TIMEOUT))
				{
				// Serial.println("==========LORAMAC_EVENT_INFO_STATUS_TX_TIMEOUT=================");
			...
			if ((NodeAckRequested == false) && (txTimeout == false))
			{
				if ((LoRaMacFlags.Bits.MlmeReq == 1) || ((LoRaMacFlags.Bits.McpsReq == 1)))
				{
					...
					{ // Procedure for the join request
                        ...
                        // Serial.println("=====S3=====OnMacStateCheckTimerEvent=================");
        ...
        //Serial.println("=====p4=====OnMacStateCheckTimerEvent=================");
	}
	...
	static void OnRxWindow1TimerEvent(void)
	{
        ...
        Serial.println("sx1262 RX1 open");
	}
	...
	static void OnRxWindow2TimerEvent(void)
	{
		...
		if (RegionRxConfig(LoRaMacRegion, &RxWindow2Config, (int8_t *)&McpsIndication.RxDatarate) == true)
		{
            ...
            Serial.println("sx1262 RX2 open");
		}
	}
	...
	static LoRaMacStatus_t ScheduleTx(void)
	{
		...
		{
		    Serial.println("sx1262 send later dutyCycleTimeOff");
	...
	LoRaMacStatus_t LoRaMacMlmeRequest(MlmeReq_t *mlmeRequest)
	{
		...
		// Serial.printf("====AAA====mlmeRequest->Type====%d===\n", mlmeRequest->Type);
		...
		case MLME_JOIN:
		{
			...
			{
				// Serial.println("==========LoRaMacMlmeRequest===(LoRaMacState & LORAMAC_TX_DELAYED) == LORAMAC_TX_DELAYED======");
				return LORAMAC_STATUS_BUSY;
			}
			...
			{
				// Serial.println("==========LoRaMacMlmeRequest=LORAMAC_STATUS_PARAMETER_INVALID====");
				return LORAMAC_STATUS_PARAMETER_INVALID;
			}
