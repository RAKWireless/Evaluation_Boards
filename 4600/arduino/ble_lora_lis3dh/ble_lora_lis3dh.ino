...
void lis3dh_get(){
  ...
  // Pressure
  lora_data[cnt++] = 0x01;
  lora_data[cnt++] = LPP_ACCELEROMETER;
  lora_data[cnt++] = (int)(SensorTwo.readFloatAccelX() * 1000) >> 8;
  lora_data[cnt++] = (int)(SensorTwo.readFloatAccelX() * 1000);
  lora_data[cnt++] = (int)(SensorTwo.readFloatAccelY() * 1000) >> 8;
  lora_data[cnt++] = (int)(SensorTwo.readFloatAccelY() * 1000);  
  lora_data[cnt++] = (int)(SensorTwo.readFloatAccelZ() * 1000) >> 8;
  lora_data[cnt++] = (int)(SensorTwo.readFloatAccelZ() * 1000);
  lora_count = cnt;
